...
public class EappMod_old extends Controller implements TestModIF {

	// public WebDriver driver;
	public boolean flag = false;
	private static Logger logger=Logger.getLogger(EappMod_old.class);
